...
WORKFLOW_URL="https://raw.githubusercontent.com/willastros-sketch/NEIA-COMFYUI/refs/heads/main/%CE%9D%CE%9E%CE%99%CE%94%E2%84%A2%20-%20GERAR%20VIDEOS%20%2B18%20-%20IMG2VID.json"
...
# Aviso sobre os Load Lora
echo "ℹ️  O workflow atual usa os nós LoraLoaderModelOnly tradicionais."
echo "   Para usar os nós OnDemand Lora Loader (que permitem colar URLs do CivitAI),"
echo "   basta substituir os nós manualmente ou editar o workflow."
echo "   O nó já está instalado! 🎉"
